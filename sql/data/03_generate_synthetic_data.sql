...
SELECT
    ...
    UNIFORM(2.00, 50.00, RANDOM())::NUMBER(12,4) AS CPM_RATE,
    UNIFORM(0.50, 5.00, RANDOM())::NUMBER(12,4) AS CPC_RATE,
    UNIFORM(0.01, 0.10, RANDOM())::NUMBER(12,4) AS CPV_RATE,
    CASE MOD(SEQ4(), 4)
        WHEN 0 THEN 'UPFRONT'
        WHEN 1 THEN 'SCATTER'
        WHEN 2 THEN 'PROGRAMMATIC'
...
SELECT
    ...
    UNIFORM(35, 250, RANDOM())::NUMBER(12,2) AS HOURLY_RATE,
    HOURLY_RATE * 2080 AS ANNUAL_SALARY,
    HOURLY_RATE * UNIFORM(1.5, 3.0, RANDOM()) AS BILLABLE_RATE,
